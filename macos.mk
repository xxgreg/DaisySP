...
ifdef GCC_PATH
CC = $(GCC_PATH)/$(PREFIX)gcc-14
CXX = $(GCC_PATH)/$(PREFIX)g++-14
AS = $(GCC_PATH)/$(PREFIX)gcc-14 -x assembler-with-cpp
...
CC = $(PREFIX)gcc-14
CXX = $(PREFIX)g++-14
AS = $(PREFIX)gcc-14 -x assembler-with-cpp
CP = $(PREFIX)objcopy
SZ = $(PREFIX)size
AR = $(PREFIX)ar
GDB = $(PREFIX)gdb
...
$(BUILD_DIR)/%.o: %.c Makefile | $(BUILD_DIR)
	$(CC) -c $(CFLAGS) $(C_STD) -static $< -o $@

$(BUILD_DIR)/%.o: %.cpp Makefile | $(BUILD_DIR)
	$(CXX) -c $(CPPFLAGS) $(CPP_STD) -static $< -o $@
